...
On April 3, 2014 the EU passes a law about net neutrality~\cite{whittaker2014eu}. In this paper, we will defend why net neutrality should not be maintained. In this introduction, \highlight{we introduce net neutrality to you by giving some history and the values behind net neutrality}. We will also give some definitions and afterwards, we present our thesis.
