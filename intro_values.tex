...
% Property value
The common argument against net neutrality is based on \emph{property rights}. The argument goes that since ISPs own their infrastructure, they have the natural right to decide how to use it. \highlight{We'll} elaborate on this argument in section \ref{sec:arguments_property}.
